...
Public Class RPT_GST_KITS
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inecom_SDK_Reporting_Package.RPT_GST_KITS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_GST_KITS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_GST_KITS = New RPT_GST_KITS()
        rpt.Site = Me.Site
        Return rpt
    End Function
