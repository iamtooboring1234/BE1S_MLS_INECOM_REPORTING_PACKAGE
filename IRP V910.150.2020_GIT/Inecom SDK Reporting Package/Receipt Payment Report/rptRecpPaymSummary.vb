...
Public Class rptRecpPaymSummary
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inecom_SDK_Reporting_Package.rptRecpPaymSummary.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptRecpPaymSummary
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptRecpPaymSummary = New rptRecpPaymSummary()
        rpt.Site = Me.Site
        Return rpt
    End Function
