...
Public Class rptRecpPaym
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_RPT_DETAILS_Pm_DS_RPT_RECPPAYMOF_Link() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptRecpPaym
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptRecpPaym = New rptRecpPaym
        rpt.Site = Me.Site
        Return rpt
    End Function
