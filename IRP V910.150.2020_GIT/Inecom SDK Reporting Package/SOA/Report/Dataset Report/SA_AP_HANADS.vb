...
Public Class SA_AP_HANADS
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inecom_SDK_Reporting_Package.SA_AP_HANADS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSA_AP_HANADS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SA_AP_HANADS = New SA_AP_HANADS()
        rpt.Site = Me.Site
        Return rpt
    End Function
