...
Public Class rptTM_SAR_V3
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inecom_SDK_Reporting_Package.rptTM_SAR_V3.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptTM_SAR_V3
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptTM_SAR_V3 = New rptTM_SAR_V3()
        rpt.Site = Me.Site
        Return rpt
    End Function
