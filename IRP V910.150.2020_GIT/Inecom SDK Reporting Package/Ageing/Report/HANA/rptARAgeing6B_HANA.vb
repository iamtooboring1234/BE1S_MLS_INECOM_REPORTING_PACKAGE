...
Public Class rptARAgeing6B_HANA
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inecom_SDK_Reporting_Package.rptARAgeing6B_HANA.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptARAgeing6B_HANA
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptARAgeing6B_HANA = New rptARAgeing6B_HANA()
        rpt.Site = Me.Site
        Return rpt
    End Function
