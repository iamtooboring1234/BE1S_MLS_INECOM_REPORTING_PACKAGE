...
Public Class rptAPAgeing_HANA
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inecom_SDK_Reporting_Package.rptAPAgeing_HANA.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptAPAgeing_HANA
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAPAgeing_HANA = New rptAPAgeing_HANA()
        rpt.Site = Me.Site
        Return rpt
    End Function
