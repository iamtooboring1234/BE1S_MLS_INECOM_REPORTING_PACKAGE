...
Public Class RRA_HANADS_WA
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inecom_SDK_Reporting_Package.RRA_HANADS_WA.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRRA_HANADS_WA
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RRA_HANADS_WA = New RRA_HANADS_WA()
        rpt.Site = Me.Site
        Return rpt
    End Function
