...
Public Class RPT_GLL_NEW
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inecom_SDK_Reporting_Package.RPT_GLL_NEW.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_GLL_NEW
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_GLL_NEW = New RPT_GLL_NEW()
        rpt.Site = Me.Site
        Return rpt
    End Function
