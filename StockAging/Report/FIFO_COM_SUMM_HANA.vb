...
Public Class FIFO_COM_SUMM_HANA
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inecom_SDK_Reporting_Package.FIFO_COM_SUMM_HANA.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFIFO_COM_SUMM_HANA
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As FIFO_COM_SUMM_HANA = New FIFO_COM_SUMM_HANA()
        rpt.Site = Me.Site
        Return rpt
    End Function
