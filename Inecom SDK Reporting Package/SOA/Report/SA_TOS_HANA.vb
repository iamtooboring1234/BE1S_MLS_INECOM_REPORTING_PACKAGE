...
Public Class SA_TOS_HANA
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inecom_SDK_Reporting_Package.SA_TOS_HANA.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSA_TOS_HANA
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SA_TOS_HANA = New SA_TOS_HANA()
        rpt.Site = Me.Site
        Return rpt
    End Function
