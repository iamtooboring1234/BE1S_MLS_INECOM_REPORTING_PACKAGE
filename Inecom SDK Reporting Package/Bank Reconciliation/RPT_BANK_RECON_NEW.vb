...
Public Class RPT_BANK_RECON_NEW
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inecom_SDK_Reporting_Package.RPT_BANK_RECON_NEW.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_BANK_RECON_NEW
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_BANK_RECON_NEW = New RPT_BANK_RECON_NEW()
        rpt.Site = Me.Site
        Return rpt
    End Function
