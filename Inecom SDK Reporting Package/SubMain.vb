...
#End If
        ...
        Catch ex As Exception
            MsgBox("[Main] : " & vbNewLine & ex.ToString)
                ...
                If oRecordSet.Fields.Item(0).Value >= 1 Then
                    ...
                    If (oRecordSet.RecordCount > 0) Then
                        ...
                        If flLicensed = True Then
                            ...
                            connStr = "DRIVER={HDBODBC};UID={" & global_DBUsername & "};PWD={" & global_DBPassword & "};SERVERNODE={" & oCompany.Server.ToString.Replace(":30013", ":30015").Replace("NDB@", "").Replace("HDB@", "") & "};DATABASE={" & oCompany.CompanyDB & "}"
