...
Public Class rptARAgeing6B_Safety
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptARAgeing6B_Safety.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptARAgeing6B_Safety
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptARAgeing6B_Safety = New rptARAgeing6B_Safety
        rpt.Site = Me.Site
        Return rpt
    End Function
