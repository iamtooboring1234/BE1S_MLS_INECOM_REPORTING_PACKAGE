...
#Region "Initialization"
    Public Sub ShowForm()
        If LoadFromXML("Inecom_SDK_Reporting_Package.ncmARAgeing.srf") Then
            oForm = SBO_Application.Forms.Item("ncmARAgeing")
    ...
    Private Function IsSharedFileExist() As Boolean
        Try
            ...
            Select Case RptType
                ...
                Case 1
                    sQuery = " SELECT IFNULL(""STRUCTUREPATH"",'') FROM ""@NCM_RPT_STRUCTURE"" "
                    sQuery &= " WHERE ""RPTCODE"" ='" & GetReportCode(ReportName.ARAging_Summary) & "'"

                    g_sReportFilename = GetSharedFilePath(ReportName.ARAging_Summary)
                    If g_sReportFilename <> "" Then
                        If IsSharedFilePathExists(g_sReportFilename) Then
                            'okay
                        End If
            ...
            Try
                ...
                If (ExecuteProcedure()) Then
                    If PrepareDataset() Then
                        ...
                        Select Case RptType
                            Case 0
                                frm.Text = "AR Ageing Details Report"
                                frm.ReportType = AgeingType.ARAgeing
                            Case 1
                                frm.Text = "AR Ageing Summary Report"
