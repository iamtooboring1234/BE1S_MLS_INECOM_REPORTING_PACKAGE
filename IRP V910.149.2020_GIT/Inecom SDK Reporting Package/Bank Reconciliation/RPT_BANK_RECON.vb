...
Public Class RPT_BANK_RECON
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inecom_SDK_Reporting_Package.RPT_BANK_RECON.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_BANK_RECON
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_BANK_RECON = New RPT_BANK_RECON()
        rpt.Site = Me.Site
        Return rpt
    End Function
