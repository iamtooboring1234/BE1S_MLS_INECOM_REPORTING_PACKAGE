...
Public Class SA_HANADS_SG
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inecom_SDK_Reporting_Package.SA_HANADS_SG.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSA_HANADS_SG
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SA_HANADS_SG = New SA_HANADS_SG()
        rpt.Site = Me.Site
        Return rpt
    End Function
