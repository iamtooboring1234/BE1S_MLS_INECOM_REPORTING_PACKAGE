...
Public Class rptARAgeing6B_HANADS
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptARAgeing6B_HANADS.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inecom_SDK_Reporting_Package.rptARAgeing6B_HANADS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptARAgeing6B_HANADS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptARAgeing6B_HANADS = New rptARAgeing6B_HANADS()
        rpt.Site = Me.Site
        Return rpt
    End Function
