...
Partial Public Class SAR_FIFO1
    ...
    Partial Public Class Excel_OutputDataTable
        ...
        Public Overloads Function AddExcel_OutputRow( _
                    ...
                    ByVal Cost8 As Decimal,  _
                    ByVal Cost9 As Decimal,  _
                    ByVal CostTotal As Decimal) As Excel_OutputRow
            Dim rowExcel_OutputRow As Excel_OutputRow = CType(Me.NewRow,Excel_OutputRow)
            Dim columnValuesArray() As Object = New Object() {DocType, ItemCode, ItemName, Whse, TransNum, DocNum, UOM, Qty1, Qty2, Qty3, Qty4, Qty5, Qty6, Qty7, Qty8, Qty9, QtyTotal, Cost1, Cost2, Cost3, Cost4, Cost5, Cost6, Cost7, Cost8, Cost9, CostTotal}
