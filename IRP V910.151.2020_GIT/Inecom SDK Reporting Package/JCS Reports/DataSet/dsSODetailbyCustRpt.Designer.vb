...
<Global.System.Serializable(),  _
 ...
 Global.System.Xml.Serialization.XmlRootAttribute("dsSODetailbyCustRpt"),  _
 Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")>  _
Partial Public Class dsSODetailbyCustRpt
    ...
    Public Overrides Function Clone() As Global.System.Data.DataSet
        Dim cln As dsSODetailbyCustRpt = CType(MyBase.Clone,dsSODetailbyCustRpt)
        cln.InitVars
    ...
    Private Sub InitClass()
        Me.DataSetName = "dsSODetailbyCustRpt"
        Me.Prefix = ""
        Me.Namespace = "http://tempuri.org/dsSODetailbyCustRpt.xsd"
    ...
    Public Shared Function GetTypedDataSetSchema(ByVal xs As Global.System.Xml.Schema.XmlSchemaSet) As Global.System.Xml.Schema.XmlSchemaComplexType
        Dim ds As dsSODetailbyCustRpt = New dsSODetailbyCustRpt()
    ...
    Partial Public Class GeneralDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddGeneralRow(ByVal CompanyName As String, ByVal DocDateFrom As Date, ByVal DocDateTo As Date, ByVal ProjectFrom As String, ByVal ProjectTo As String, ByVal IsCancelled As String, ByVal BPFrom As String, ByVal BPTo As String) As GeneralRow
            Dim rowGeneralRow As GeneralRow = CType(Me.NewRow,GeneralRow)
            Dim columnValuesArray() As Object = New Object() {CompanyName, DocDateFrom, DocDateTo, ProjectFrom, ProjectTo, IsCancelled, BPFrom, BPTo}
    ...
    Partial Public Class TableReportDataTable
        Inherits Global.System.Data.TypedTableBase(Of TableReportRow)
        ...
        Public Overloads Function AddTableReportRow( _
            ...
            Dim columnValuesArray() As Object = New Object() {CardCode, CardName, DocDate, DocEntry, DocCur, Series, SeriesName, DocNum, LineNum, ItemCode, Dscription, Price, Quantity, LineTotal, Project, Rate, TotalFrgn}
