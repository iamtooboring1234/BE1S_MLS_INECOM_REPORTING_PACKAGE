...
Public Class PageHeader_HANA
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inecom_SDK_Reporting_Package.PageHeader_HANA.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPageHeader_HANA
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PageHeader_HANA = New PageHeader_HANA()
        rpt.Site = Me.Site
        Return rpt
    End Function
