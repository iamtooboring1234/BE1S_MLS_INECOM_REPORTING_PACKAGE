...
#Region "Global Variables"
    ...
    Private oMrx As SAPbouiCOM.Matrix
    Private oCol As SAPbouiCOM.Column
...
#Region "General Functions"
    Public Sub LoadForm()
        If LoadFromXML("Inecom_SDK_Reporting_Package.ncmSOA_SendEmailProj.srf") Then
            oForm = SBO_Application.Forms.Item("ncmSOA_SendEmailProj")
            AddDataSource()
            SetDatasource()
            InitializeForm()
            oForm.Visible = True
        ...
        Else
            Try
                ...
                End If
            Catch ex As Exception
                MessageBox.Show("[ncmSOA_SendEmailProj].[LoadForm] - " & ex.Message)
            End Try
        End If
    End Sub
                        ...
                        If pVal.ItemUID = "mrxList" AndAlso pVal.Row = 0 Then
                            If pVal.ColUID = "Col01" Then
                                ...
                                Try
                                    ...
                                    For i As Integer = 2 To oMrx.VisualRowCount Step 1
                                        oMrx.GetLineData(i)
