...
Public Class SA_AP_HANA_Inecom
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inecom_SDK_Reporting_Package.SA_AP_HANA_Inecom.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSA_AP_HANA_Inecom
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SA_AP_HANA_Inecom = New SA_AP_HANA_Inecom()
        rpt.Site = Me.Site
        Return rpt
    End Function
