...
Public Class SA_LANDSCAPE_HANA
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inecom_SDK_Reporting_Package.SA_LANDSCAPE_HANA.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSA_LANDSCAPE_HANA
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SA_LANDSCAPE_HANA = New SA_LANDSCAPE_HANA()
        rpt.Site = Me.Site
        Return rpt
    End Function
