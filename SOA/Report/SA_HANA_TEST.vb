...
Public Class SA_HANA_TEST
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inecom_SDK_Reporting_Package.SA_HANA_TEST.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSA_HANA_TEST
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SA_HANA_TEST = New SA_HANA_TEST()
        rpt.Site = Me.Site
        Return rpt
    End Function
