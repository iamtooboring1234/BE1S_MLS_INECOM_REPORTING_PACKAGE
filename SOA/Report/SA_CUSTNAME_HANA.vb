...
Public Class SA_CUSTNAME_HANA
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inecom_SDK_Reporting_Package.SA_CUSTNAME_HANA.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSA_CUSTNAME_HANA
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SA_CUSTNAME_HANA = New SA_CUSTNAME_HANA()
        rpt.Site = Me.Site
        Return rpt
    End Function
