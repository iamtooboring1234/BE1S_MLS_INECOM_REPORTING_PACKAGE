...
Public Class SA_INECOM_HANADS
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inecom_SDK_Reporting_Package.SA_INECOM_HANADS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSA_INECOM_HANADS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SA_INECOM_HANADS = New SA_INECOM_HANADS()
        rpt.Site = Me.Site
        Return rpt
    End Function
