...
Public Class SA_OM_HANADS
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inecom_SDK_Reporting_Package.SA_OM_HANADS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSA_OM_HANADS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SA_OM_HANADS = New SA_OM_HANADS()
        rpt.Site = Me.Site
        Return rpt
    End Function
