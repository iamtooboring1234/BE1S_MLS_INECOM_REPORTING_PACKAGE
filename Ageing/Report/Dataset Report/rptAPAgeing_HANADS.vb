...
Public Class rptAPAgeing_HANADS
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inecom_SDK_Reporting_Package.rptAPAgeing_HANADS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptAPAgeing_HANADS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAPAgeing_HANADS = New rptAPAgeing_HANADS()
        rpt.Site = Me.Site
        Return rpt
    End Function
