...
Public Class rptARAgeing_CRM_HANADS
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptARAgeing_CRM_HANADS.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_SUBCRM_Pm_OCRDCardCode() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptARAgeing_CRM_HANADS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptARAgeing_CRM_HANADS = New rptARAgeing_CRM_HANADS
        rpt.Site = Me.Site
        Return rpt
    End Function
