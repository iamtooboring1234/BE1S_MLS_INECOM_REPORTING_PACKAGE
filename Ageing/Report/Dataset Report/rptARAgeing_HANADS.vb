...
Public Class rptARAgeing_HANADS
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inecom_SDK_Reporting_Package.rptARAgeing_HANADS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptARAgeing_HANADS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptARAgeing_HANADS = New rptARAgeing_HANADS()
        rpt.Site = Me.Site
        Return rpt
    End Function
