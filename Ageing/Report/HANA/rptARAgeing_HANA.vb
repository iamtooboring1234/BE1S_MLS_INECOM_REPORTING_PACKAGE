...
Public Class rptARAgeing_HANA
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inecom_SDK_Reporting_Package.rptARAgeing_HANA.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptARAgeing_HANA
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptARAgeing_HANA = New rptARAgeing_HANA()
        rpt.Site = Me.Site
        Return rpt
    End Function
