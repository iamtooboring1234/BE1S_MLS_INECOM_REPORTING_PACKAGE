...
Public Class rptARAgeing_HANA_Inecom_20150828
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptARAgeing_HANA_Inecom_20150828.RPT"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inecom_SDK_Reporting_Package.rptARAgeing_HANA_Inecom_20150828.RPT"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptARAgeing_HANA_Inecom_20150828
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptARAgeing_HANA_Inecom_20150828 = New rptARAgeing_HANA_Inecom_20150828()
        rpt.Site = Me.Site
        Return rpt
    End Function
