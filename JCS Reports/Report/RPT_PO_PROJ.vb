...
Public Class RPT_PO_PROJ
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inecom_SDK_Reporting_Package.RPT_PO_PROJ.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_PO_PROJ
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_PO_PROJ = New RPT_PO_PROJ()
        rpt.Site = Me.Site
        Return rpt
    End Function
