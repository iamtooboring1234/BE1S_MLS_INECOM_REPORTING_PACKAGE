...
Public Class SA_SAF_HANA_2014
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inecom_SDK_Reporting_Package.SA_SAF_HANA_2014.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSA_SAF_HANA_2014
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SA_SAF_HANA_2014 = New SA_SAF_HANA_2014()
        rpt.Site = Me.Site
        Return rpt
    End Function
