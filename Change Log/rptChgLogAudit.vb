...
Public Class rptChgLogAudit
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inecom_SDK_Reporting_Package.rptChgLogAudit.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptChgLogAudit
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptChgLogAudit = New rptChgLogAudit()
        rpt.Site = Me.Site
        Return rpt
    End Function
